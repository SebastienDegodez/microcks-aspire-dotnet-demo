...
internal static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection ConfigureMicrocksProvider(this IServiceCollection services, MicrocksResource microcksResource)
    {
        ...
        services.AddKeyedScoped<IMicrocksProvider>(name, (serviceProvider, serviceKey) =>
        {
            IMicrocksClient microcksClient = serviceProvider.GetRequiredKeyedService<IMicrocksClient>(serviceKey);
            ILoggerFactory loggerFactory = serviceProvider.GetRequiredService<ILoggerFactory>();
            var provider = new MicrocksProvider(microcksClient, loggerFactory);
